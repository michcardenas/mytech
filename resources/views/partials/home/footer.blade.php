<footer class="bg-white border-t border-mt-border pt-24 md:pt-32 pb-10 relative overflow-hidden">
    <div class="mt-container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-mt-border">
            ...
            <div class="md:col-span-1">
                ...
                <p class="text-mt-text-2 text-sm leading-relaxed">
                    Desarrollo web profesional que impulsa tu negocio.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    <li><a href="{{ route('home.v2') }}"               class="text-mt-text-2 hover:text-mt-accent transition text-sm">Inicio</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    <li><a href="https://www.facebook.com/profile.php?id=61575108256490" target="_blank" rel="noopener" class="text-mt-text-2 hover:text-mt-accent transition text-sm flex items-center gap-2">
                    ...
                    <li><a href="https://www.instagram.com/mytech_solutions" target="_blank" rel="noopener" class="text-mt-text-2 hover:text-mt-accent transition text-sm flex items-center gap-2">
                    ...
                    <li><a href="https://wa.me/573337246403" target="_blank" rel="noopener" class="text-mt-text-2 hover:text-mt-accent transition text-sm flex items-center gap-2">
            ...
            <div>
                ...
                <a href="https://wa.me/573337246403?text=Hola%2C%20me%20interesa%20cotizar%20un%20proyecto"
                   target="_blank" rel="noopener"
                   class="block text-mt-text hover:text-mt-accent transition text-base font-semibold">
                    +57 333 724 6403
                </a>
                <p class="mt-1 text-xs text-mt-text-3">WhatsApp comercial</p>
