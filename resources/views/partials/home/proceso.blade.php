@php
     ...
     * Contenido editable más adelante desde admin/pages si el cliente lo pide.
     */
    $pasos = [
        [
            'num'    => '01',
            'title'  => 'Descubrimos',
            'lead'   => 'Conversación profunda para entender tu negocio.',
            'desc'   => 'Identificamos objetivos, audiencia, presupuesto y plazos. Salimos con un plan técnico claro y una propuesta sin ambigüedades.',
            'tags'   => ['Análisis', 'Estrategia', 'Roadmap'],
        ],
        [
            'num'    => '02',
            'title'  => 'Diseñamos',
            'lead'   => 'Arquitectura técnica y experiencia de usuario.',
            'desc'   => 'Definimos stack, integraciones y flujos UX/UI antes de escribir una línea de código. Validamos contigo cada decisión.',
            'tags'   => ['UX/UI', 'Stack', 'Integraciones'],
        ],
        [
            'num'    => '03',
            'title'  => 'Construimos',
            'lead'   => 'Desarrollo iterativo con previews semanales.',
            'desc'   => 'Recibes avances cada semana y puedes pedir ajustes en cada sprint. Código limpio, documentado y probado. Sin sorpresas.',
            'tags'   => ['Laravel', 'Vue · React', 'Testing'],
        ],
        [
            'num'    => '04',
            'title'  => 'Lanzamos',
            'lead'   => 'Deploy, capacitación y soporte continuo.',
            'desc'   => 'Subimos a producción, capacitamos a tu equipo y quedamos disponibles para mejoras, ajustes y nuevas funcionalidades.',
            'tags'   => ['Deploy', 'Capacitación', 'Soporte'],
        ],
    ];
@endphp
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center min-h-[60vh]">
                    <div class="lg:col-span-5">
                        ...
                        <h2 class="mt-4 text-section font-display text-mt-text">
                            De una idea a una plataforma en <span class="text-mt-accent">producción</span>.
                        </h2>
                        <p class="mt-5 text-mt-text-2 text-base md:text-lg leading-relaxed max-w-md">
                            Cuatro fases, comunicación constante y entregables claros en cada paso. Así llevamos cada proyecto desde la primera conversación hasta el lanzamiento.
                        </p>
